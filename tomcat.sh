...
sudo cp /tmp/migration/sslkey/webserverkey /usr/share/tomcat/conf/sslkey/webserverkey
...
sudo cp /tmp/migration/tomcat_manager.conf /etc/httpd/conf.d/tomcat_manager.conf
